...
| --------------- |:---------:|:---:|:-------:|:----------|:------:|
| Bukalapak | Bukalapak Dev | [api_doc](https://github.com/arbiyanto/api_doc)  | `Aktif` | API dari *e-commerce* terkenal di Indonesia sebagai situs jual-beli daring (*online*) | `apiKey` |
